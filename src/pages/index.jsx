...
<br></br><br></br><br></br><br></br><br></br>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <Image className="d-block w-100" src="/images/f9.jpg" alt="First slide" width={400} height={300}/>
    </div>
    ...
    <div className="carousel-item">
      <Image className="d-block w-100" src="/images/planning-.jpg" alt="Third slide"  width={400} height={300}/>
    </div>
    <div class="carousel-item">
      <Image className="d-block w-100" src="/images/project.png" alt="Fourth slide"  width={400} height={300}/>
    </div>
