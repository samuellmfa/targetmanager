...
export default function HomePage( {username,Organization} ) {
    ...
    return (
        <>
        <Head>
          <title>Work managgment software</title>
      ...
      <h1> Cloud Employee performance evaluation </h1>
          {/* <Image
          ...
          {/* <a
            ...
            {username ?
         <>
         <a href="/target" target="_self"rel="noopener noreferrer"><p> Your {Organization} target Plan&nbsp;</p></a>
         <a href="/month" target="_self"rel="noopener noreferrer"><p> Your {Organization} Monthly Plan&nbsp;</p></a>
         <a href="/weekly" target="_self"rel="noopener noreferrer"><p> Your  {Organization} Weekly Plan&nbsp;</p></a>
         </>
        : 
        <>
        ...
        {username ?
        <>
            <strong className={styles.card}>Hi {username}</strong>
        ...
        <>
          ...
          <div className={styles.grid}>
            ...
            >
              ...
              <p>
                Discover the potential of planning .
              </p>
            </a>
            ...
            >
              ...
              <p>
                Instantly create Department structure and create employee profile &nbsp; easy .
              </p>
            </a>
          </div>
